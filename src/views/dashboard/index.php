            ...
            <?php if (isset($team) && $team): ?>
                    ...
                    <?php if (!isset($payment) || !$payment): ?>
                        <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-xl p-6 shadow-sm">
                            ...
                            <a href="/dashboard/payment" class="inline-flex items-center px-5 py-2.5 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-[#bc0301] hover:bg-[#bc0301]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-150">
                    ...
                    <?php elseif ($payment['status'] === 'rejected'): ?>
                        <div class="mt-6 bg-red-50 border border-red-200 rounded-xl p-6 shadow-sm">
                            ...
                            <?php endif; ?>
                            <a href="/dashboard/payment" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-[#bc0301] hover:bg-[#bc0301]/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition duration-150">
                                Upload Ulang
                            </a>
                        </div>
                    <?php endif; ?>
